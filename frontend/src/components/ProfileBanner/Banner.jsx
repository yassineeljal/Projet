      ...
      <div className="relative flex items-center space-x-6">
        ...
        <div className="relative group">
          <img
            ...
            onClick={triggerFileInput} // Utilisation de la fonction qui simule le clic
          />
          <FaEdit className="absolute inset-0 m-auto text-3xl text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100 cursor-pointer" />
        </div>
        <div>
